...
f = open(global_dirs.poly_regression_path+'best_params.pkl', 'rb')
...
poly_X = PolynomialFeatures(**best_params)#degree=3) #This is extracted from best_params
...
results.to_csv(global_dirs.poly_regression_path+"results/{}-fold-cross-validation-results.csv".format(folds),",",mode="w",header=True)