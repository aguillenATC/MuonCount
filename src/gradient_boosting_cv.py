...
f = open(global_dirs.gradient_boosting_path+'best_params.pkl', 'rb')
...
gb=GradientBoostingRegressor(**best_params)#max_depth=16,learning_rate=0.1) #This is extracted from best_params
...
results.to_csv(global_dirs.gradient_boosting_path+"results/{}-fold-cross-validation-results.csv".format(folds),",",mode="w",header=True)