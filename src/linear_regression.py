...
train=pd.concat(manager.read_data(global_dirs.splitted_data_path, formats=["hdf"], train="train",verbose=False)[1].values())
validation=pd.concat(manager.read_data(global_dirs.splitted_data_path, formats=["hdf"], train="validation",verbose=False)[1].values())
...
regression_model=manager.fit_linear_regression()


if not os.path.isdir(global_dirs.results_path):
    os.mkdir(global_dirs.results_path)
if not os.path.isdir(global_dirs.linear_regression_path):
    os.mkdir(global_dirs.linear_regression_path)
if not os.path.isdir(global_dirs.linear_regression_path+"scalers/"):
    os.mkdir(global_dirs.linear_regression_path+"scalers/")
if not os.path.isdir(global_dirs.linear_regression_path+"model/"):
    os.mkdir(global_dirs.linear_regression_path+"model/")
if not os.path.isdir(global_dirs.linear_regression_path+"results/"):
    os.mkdir(global_dirs.linear_regression_path+"results/")


if(isinstance(scalers,tuple)):
    joblib.dump(scalers[0], global_dirs.linear_regression_path + "scalers/scaler_X.h5")
    joblib.dump(scalers[1], global_dirs.linear_regression_path + "scalers/scaler_y.h5")
else:
    joblib.dump(scalers, global_dirs.linear_regression_path + "scalers/scaler_X.h5")
joblib.dump(regression_model, global_dirs.linear_regression_path + "/model/model.h5")
...
for name,ds in test.items():
    ...
    results=manager.predict_linear_regression(ds,tup)
    ...
    #plt.show()
    plt.savefig(global_dirs.linear_regression_path + "results/qgsjet-results-{}.png".format(name), dpi=70)
...
for name,ds in test.items():
    ...
    #plt.show()
    plt.savefig(global_dirs.linear_regression_path + "results/epos-results-{}.png".format(name), dpi=70)
...
for name,ds in test.items():
    ...
    #plt.show()
    plt.savefig(global_dirs.linear_regression_path + "results/qgsjet-results-WHOLE-{}.png".format(name), dpi=70)