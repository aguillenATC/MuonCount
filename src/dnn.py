...
for name,ds in test.items():
    ...
    ax[1].set_title("Deep Neural Net\nQGSJET-II (test)\nReal vs. Predicted - {}".format(name))
    ...
    # plt.show()
    plt.savefig(global_dirs.dnn_path + "results/qgsjet-results-{}.png".format(name), dpi=70)
...
for name,ds in test.items():
    ...
    #plt.show()
    plt.savefig(global_dirs.dnn_path + "results/epos-results-{}.png".format(name), dpi=70)
...
for name,ds in test.items():
    ...
    # plt.show()
    plt.savefig(global_dirs.dnn_path + "results/qgsjet-results-WHOLE-{}.png".format(name), dpi=70)
