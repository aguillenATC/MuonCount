...
f = open(global_dirs.decision_tree_path+'best_params.pkl', 'rb')
...
dt=DecisionTreeRegressor(**best_params) #This is extracted from best_params
...
results.to_csv(global_dirs.decision_tree_path+"results/{}-fold-cross-validation-results.csv".format(folds),",",mode="w",header=True)