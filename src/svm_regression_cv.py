...
f = open(global_dirs.svm_path+'best_params.pkl', 'rb')
...
svr=SVR(**best_params) #This is extracted from best_params
...
results.to_csv(global_dirs.svm_path+"results/{}-fold-cross-validation-results.csv".format(folds),",",mode="w",header=True)