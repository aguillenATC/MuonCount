...
f = open(global_dirs.random_forest_path+'best_params.pkl', 'rb')
...
rf=RandomForestRegressor(**best_params)#max_depth=52) #This is extracted from best_params
...
results.to_csv(global_dirs.random_forest_path+"results/{}-fold-cross-validation-results.csv".format(folds),",",mode="w",header=True)